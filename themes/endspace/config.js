...
const CONFIG = {
  ...
  // 加载动画显示的站点名称 (右侧竖排大字)
  ENDSPACE_LOADING_SITE_NAME: 'CUSTOM_KEYBOAED_DATABASE', // 站点名称，显示在加载动画右侧
  ...
  ENDSPACE_BANNER_WATERMARK_TEXT: 'CUSTOM_KEYBOAED_DATABASE',
  // 文章详情页右上角水印文字
  ENDSPACE_ARTICLE_WATERMARK_TEXT: 'XIAOFENG',
